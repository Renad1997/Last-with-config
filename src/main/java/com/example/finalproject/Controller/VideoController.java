...
public class VideoController {
    ...
    public ResponseEntity addVideo(@Valid @RequestBody Video video, @PathVariable Integer sessionId, @AuthenticationPrincipal User user) {
        videoService.addVideo(video, sessionId, user);
        return ResponseEntity.status(201).body(new ApiResponse("Video added successfully"));
    }
